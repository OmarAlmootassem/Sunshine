...
public class TestDb extends AndroidTestCase {
    ...
    public void testInsertReadDb() {
        // If there's an error in the SQL table creation strings, errors will be thrown here when
        // you try to get a writable database.
        ...
        // Check that we received a row back.
        assertTrue(locationRowId != -1);
        Log.d(LOG_TAG, "New row id: " + locationRowId);

        // Data's inserted. Now check them and verify they made it back
        ...
        // Now that we have a location, insert the weather information
